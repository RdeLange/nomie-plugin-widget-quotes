<script context="module">
  let quotes = {
    "quotes": [
      ...
      {
        "text": "When you arise in the moring, think of what a precious privelege it is to be alive-- to breathing, to think, to enjoy, to love.",
        "author": "Marcus Aurelius"
      },
      {
      ...
      {
        "text": "When you arise in the morning, think of what a precious privilege it is to be alive-to breathing, to think, to enjoy, to love.",
        "author": "Marcus Aurelius"
      },
      {
      ...
      {
        "text": "You have power over your mind - not outside events. Realize this, and you will find strength. When you arise in the morning, think of what a precious privilege it is to be alive - to breathing, to think, to enjoy, to love.",
        "author": "Marcus Aurelius"
      },
      {
  ...
  export function getQuoteOfDay(){
      var intQuoteCount = quotes.quotes.length; // The number of quotes in your library
      var dtNow = new Date();
  ...
  return quotes.quotes[intQuoteToDisplay];
  }
  </script>